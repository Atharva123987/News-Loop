...
export const Categories = () => {
  ...
  useEffect(() => {
    async function fetchCategoryData() {
      setLoading(1);
      const response = await axios.get(`https://newsdata.io/api/1/news?apikey=pub_1950067b94bfb84a24b136904cafa93a704ab&category=${category}&page=${nextPage}&language=en`);
  ...
  useEffect(() => {
    async function fetchCountryData() {
      setLoading(1);
      const response = await axios.get(`https://newsdata.io/api/1/news?apikey=pub_1950067b94bfb84a24b136904cafa93a704ab&country=${country}&page=${nextPage}&language=en`);
        setData(response.data.results);
    ...
    async function firstFetch(){
      const response = await axios.get(`https://newsdata.io/api/1/news?apikey=pub_1950067b94bfb84a24b136904cafa93a704ab&country=in&page&language=en`);
      setNextPage(await response.data.nextPage);
      setPageAddress(current => [... current, nextPage])
      setData(response.data.results);
    }
